...
function buildPrompt(project: string, runId: string, workflowIds: string[], caseIds: string[]): string {
  ...
  return [
    ...
    "(a.1) If a signup/registration form has a Terms/Conditions or Privacy checkbox, you MUST check it before submitting. If submission is blocked due to terms/privacy validation, mark that test case FAIL.",
    ...
    "(f) Include those browser errors in each case detail as JSON under key 'browser_errors' along with a short summary.",
